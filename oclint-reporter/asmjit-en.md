...
same error in [asmjit/src/asmjit/base/zone.cpp 154](asmjit/src/asmjit/base/zone.cpp#L154), [493](asmjit/src/asmjit/base/zone.cpp#L493)line, [789](asmjit/src/asmjit/base/zone.cpp#L789)line, error message: Pointer to local variable 'newData' is stored ...<br>
...
Explanation of k415: **false condition in do while**
...
Explanation of k416: **Unconditional jump statement in loop.**
