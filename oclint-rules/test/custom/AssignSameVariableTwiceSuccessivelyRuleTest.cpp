...
TEST(AssignSameVariableTwiceSuccessivelyRuleTest, Test1)
{
    ...
    testRuleOnCode(new AssignSameVariableTwiceSuccessivelyRule(),                     
                      "void foo(){for(int i=0;i<10;i++){int aa,b;aa=1;\naa=2;}}",
            0, 2, 1, 2, 4, "The 'aa' object is assigned values twice successively. Perhaps this is a mistake.");
}
